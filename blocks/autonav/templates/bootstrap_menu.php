...
foreach ($navItems as $ni) {
	...
	if($ni->hasSubmenu) {
		...
		//echo '<a href="' . $ni->url . '" data-target="#" class="dropdown-toggle" data-toggle="dropdown" role="button">' . $ni->name . ' <b class="caret"></b></a>'; //opens a dropdown sub-menu
		echo '<a href="' . $ni->url . '" role="button">' . $ni->name . ' </a><a href="' . $ni->url . '" data-target="#" class="dropdown-toggle" data-toggle="dropdown" role="button"><b class="caret"></b></a>'; //opens a dropdown sub-menu
	...
	switch ($ni->level) {
		case '1':
			echo '<li class="' . $ni->classes . '"><a href="' . $ni->url . '" target="' . $ni->target . '" >' . $ni->name . '</a></li>';
			break;
